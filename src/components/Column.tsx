...
export default function Column({ title, status, tasks, onAddTask, onDeleteTask }: ColumnProps) {
    return (
            ...
            <Droppable droppableId={status}>
                {(provided, snapshot) => (
                    <div
                        ...
                        className={`flex-1 bg-gray-100/50 dark:bg-slate-800/50 rounded-xl p-3 overflow-y-auto transition-colors border border-transparent ${snapshot.isDraggingOver ? 'bg-blue-50/50 dark:bg-blue-900/20 ring-2 ring-blue-100 dark:ring-blue-900' : ''
                            }`}
                    >
